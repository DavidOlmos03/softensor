    ...
    <div
      className={
        cn
          ...
          : `relative min-h-screen w-full ${className ?? ""}`
      }
    >
...
const CircuitLayer = ({ svgOptions }: { svgOptions?: { duration?: number } }) => {
  return (
    <>
  ...
  return (
    ...
    >
      ...
      <motion.g
        animate={{ x: [0, -1000] }}
        transition={{
          duration: (svgOptions?.duration || 6) * 4,
          repeat: Infinity,
          ease: "linear"
        }}
      >
        <g transform="translate(0 0)">
          <CircuitLayer svgOptions={svgOptions} />
        </g>
